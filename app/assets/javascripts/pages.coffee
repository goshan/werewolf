...
$(document).on 'turbolinks:load', (e) ->
  ...
  $('#js-deal-type-nav li a').click (e) ->
    deal_type = $(e.currentTarget).attr('deal_type')
    App.admin.do 'deal_type', deal_type: deal_type

  $('#js-add-coin-all-players').click (e) ->
    e.preventDefault()
    coin = parseInt($('#coin-to-patch').val(), 10) || 0
    App.admin.do 'add_coin_all_players', coin: coin

  $('#js-reset-coin-all-players').click (e) ->
    e.preventDefault()
    App.admin.do 'add_coin_all_players', coin: -1
